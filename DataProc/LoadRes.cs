...
public class LoadRes : MonoBehaviour {
 ...
 //   private int storySeq = 0;
    ...
    void LoadXml()
    {
        ...
        // 加载故事关卡表
        string storyLevelPath = Application.dataPath + "/Xml/story_level.xml";
